...
export default function CourseCard() {
    return (
        <div className="shadow-md p-4 rounded-lg lg:hover:-translate-y-2 duration-300">
            <div className="border-b py-2">
                <h1 className="text-neutral-900 text-lg font-medium">Frontend dasturlash kurslari</h1>
            </div>
            <div>
